    ...
    (function(f) {
      ...
      var Ue = (a, t) => {
        ...
        if (t && typeof t == "object" || typeof t == "function")
          for (let i of Ws(t))
            !Js.call(a, i) && i !== e && Re(a, i, { get: () => t[i], enumerable: !(s = Hs(t, i)) || s.enumerable });
        return a;
      };
      ...
      var Ze = class extends Qe {
        ...
        finalizeComment(t) {
          ...
          if (t.leadingNode !== null || t.trailingNode !== null)
            t.leadingNode !== null && is(t.leadingNode, e), t.trailingNode !== null && Vi(t.trailingNode, e);
          else {
      ...
      function Vt(a, t, e, s, i, r) {
        ...
        for (; ; ) {
          ...
          if (x === 92) {
            ...
            x === 8232 || x === 8233 ? (++e, ++i, s = e) : x === 10 || x === 13 ? a === "template" ? (l += t.slice(f, e) + `
...
`);
      ...
      function pt(a) {
        var _a;
        if ((_a = a.extra) == null ? void 0 : _a.parenthesized)
          return false;
        switch (a.type) {
          case "Identifier":
            return true;
      ...
      var Qi = (a) => class extends a {
        ...
        parseVarStatement(e, s, i = false) {
          ...
          for (let { id: o, init: h } of n.declarations)
            h && (s === "var" || s === "let" || o.typeAnnotation ? this.raise(y.InitializerNotAllowedInAmbientContext, h) : er(h, this.hasPlugin("estree")) || this.raise(y.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference, h));
          return n;
        }
        ...
        parseMaybeAssign(e, s) {
          ...
          if (!r && (qt(!this.hasPlugin("jsx")), n = this.tryParse(() => super.parseMaybeAssign(e, s), i), !n.error))
            return n.node;
          if (r == null ? void 0 : r.node)
            return this.state = r.failState, r.node;
          if (h.node)
            return this.state = h.failState, o && this.reportReservedArrowTypeParam(o), h.node;
          if (n == null ? void 0 : n.node)
            return this.state = n.failState, n.node;
      ...
      var Kt = F`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), sr = (a) => class extends a {
        ...
        parseExpressionStatement(e, s) {
          var _a;
          if (s.type !== "Placeholder" || ((_a = s.extra) == null ? void 0 : _a.parenthesized))
      ...
      function rr(a) {
        ...
        if (!a.has("deprecatedImportAssert") && a.has("importAttributes") && a.get("importAttributes").deprecatedAssertSyntax)
...
`), cooked: r === null ? null : r.slice(1, l) }, o.tail = h, this.next();
      ...
      var ft = class extends ut {
        ...
        parseExport(t, e) {
          ...
          if (l || u || f) {
            let d = t;
            if (this.checkExport(d, true, false, !!d.source), ((_a = d.declaration) == null ? void 0 : _a.type) === "ClassDeclaration")
        ...
        checkExport(t, e, s, i) {
          ...
          if (e) {
            ...
            } else if ((_b = t.specifiers) == null ? void 0 : _b.length)
...
`);
      ...
      function Er(a) {
        ...
        for (let e = a.length - 1; e >= 0; e--) {
          let s = a[e];
          if (t && L(s) === M(t) && Et(s) && Et(t) && (a.splice(e + 1, 1), s.value += "*//*" + t.value, s.range = [M(s), L(t)]), !Ts(s) && !se(s))
...
`);
      ...
      function Wr(a, t) {
        if (t == null ? void 0 : t.endsWith(".js.flow"))
          return true;
        let e = ve(a);
      ...
      function Gr({ isExpression: a = false, optionsCombinations: t }) {
        return (e, s = {}) => {
          let { filepath: i } = s;
          if (typeof i != "string" && (i = void 0), (s.parser === "babel" || s.parser === "__babel_estree") && Wr(e, i))
      ...
      function re(a) {
        switch (a.type) {
          ...
          case "ObjectProperty":
            if (a.computed)
              throw q(a.key, "Computed key");
            if (a.shorthand)
              throw q(a.key, "Shorthand property");
            a.key.type !== "Identifier" && re(a.key), re(a.value);
            return;
          case "UnaryExpression": {
            let { operator: t, argument: e } = a;
            if (t !== "+" && t !== "-")
              throw q(a, `Operator '${a.operator}'`);
